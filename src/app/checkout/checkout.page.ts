...
export class CheckoutPage implements OnInit {
  ...
  async order() {
    ...
    var allData = { user_id: localStorage.getItem('user_id'), payment: this.payment, address: addr, cart_no: localStorage.getItem('cart_no'), payment_id: this.payment_id, otype: this.otype, notes: localStorage.getItem('notes') }
